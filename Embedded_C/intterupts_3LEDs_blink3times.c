/*
CODE BLINK 3 LEDs Simalteneously  3 times when the switch is pressed once
*/
...
//Deal with output pins
  DDRB |=(1<<PB0);//SET PB0 = pin 8 as output on UNO
  DDRB |=(1<<PB4);//SET PB4 = pin 12 as output on UNO
  DDRB |=(1<<PB5);//SET PB5 = pin 13 as output on UNO
